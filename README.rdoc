...
Updated to only work on Linux. The Windows port needs Ruby 1.9 and we dont need that yet. For those of us that use Ruby 1.8 and Linux, this port should work
